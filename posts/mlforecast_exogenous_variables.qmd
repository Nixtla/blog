...
MLForecast handles this automatically. First, configure the forecasting pipeline:
...
|---|-----------|------------|---------------|
| 0 | id_00     | 2001-05-15 | 418.961670    |
| 1 | id_00     | 2001-05-16 | 500.962133    |
| 2 | id_00     | 2001-05-17 | 19.935077     |
| 3 | id_00     | 2001-05-18 | 102.535201    |
| 4 | id_00     | 2001-05-19 | 184.815386    |
...
|   | unique_id | ds         | price       |
|---|-----------|------------|-------------|
| 0 | id_00     | 2000-01-01 | 0.548814    |
| 1 | id_00     | 2000-01-02 | 0.715189    |
| 2 | id_00     | 2000-01-03 | 0.602763    |
| 3 | id_00     | 2000-01-04 | 0.544883    |
| 4 | id_00     | 2000-01-05 | 0.423655    |
...
- **Static features** (`store_id`, `product_id`): Carried from the training data, constant for each series.
- **Dynamic exogenous** (`price`): Provided via `X_df`, varies over time.
- **Lag features** (`lag7`, `expanding_mean_lag1`, `rolling_mean_lag7_window_size14`): Auto-generated from historical values based on `lags` and `lag_transforms`.
...
|   | unique_id | ds         | LGBMRegressor |
|---|-----------|------------|---------------|
| 0 | id_00     | 2001-05-15 | 425.289536    |
| 1 | id_00     | 2001-05-16 | 499.363551    |
| 2 | id_00     | 2001-05-17 | 21.152481     |
| 3 | id_00     | 2001-05-18 | 102.144971    |
| 4 | id_00     | 2001-05-19 | 185.067341    |
